...
export default function ProductClient({ product, isAuthenticated }: Props) {
  ...
  }, [selectedVariantId, product.variants?.edges]);
            ...
            {isAuthenticated ? (
              <>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                  <p style={{ fontSize: '14px', fontWeight: 500 }}>£{formattedPrice}</p>
                </div>
              ...
              >
                <p style={{ fontWeight: 600 }}>CATALOGUE VIEW</p>
                <br />
